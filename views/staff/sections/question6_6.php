...
<div class="middle">
    ...
    <table class="table table-bordered table-responsive center">
        ...
        <tr>
            <td>1)</td>
            <td><input type="checkbox" v-model="questions.q6_7_1" id="q6_7_1_1" value="학생지원 활동의 홍보 강화"></td>
            <td><label for="q6_7_1_1"> 학생지원 활동의 홍보 강화</label></td>

            <td>2)</td>
            <td><input type="checkbox" v-model="questions.q6_7_1" id="q6_7_1_2" value="학생지원 활동의 체계 고도화"></td>
            <td><label for="q6_7_1_2"> 학생지원 활동의 체계 고도화</label></td>
        </tr>

        <tr>
            <td>3)</td>
            <td><input type="checkbox" v-model="questions.q6_7_1" id="q6_7_1_3" value="학생지원 활동의 선택과 집중"></td>
            <td><label for="q6_7_1_3"> 학생지원 활동의 선택과 집중</label></td>

            <td>4)</td>
            <td><input type="checkbox" v-model="questions.q6_7_1" id="q6_7_1_4" value="대학의 행재정적 지원 강화"></td>
            <td><label for="q6_7_1_4"> 대학의 행재정적 지원 강화</label></td>
        </tr>

        <tr>
            <td>5)</td>
            <td><input type="checkbox" v-model="questions.q6_7_1" id="q6_7_1_5" value="담당자의 전문성 강화"></td>
            <td><label for="q6_7_1_5"> 담당자의 전문성 강화</label></td>

            <td>6)</td>
            <td><input type="checkbox" v-model="questions.q6_7_1" id="q6_7_1_6" value="선진 학생지원 프로그램 도입"></td>
            <td><label for="q6_7_1_6"> 선진 학생지원 프로그램 도입</label></td>
        </tr>

        <tr>
            <td>7)</td>
            <td><input type="checkbox" v-model="questions.q6_7_1" id="q6_7_1_7" value="관련 행정 업무의 효율화"></td>
            <td><label for="q6_7_1_7"> 관련 행정 업무의 효율화</label></td>

            <td>8)</td>
            <td>기타: </td>
            <td><input type="text" v-model="questions.q6_7_other" class="form-control"></td>
        </tr>
        </thead>
    </table>
