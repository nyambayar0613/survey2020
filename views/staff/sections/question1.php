...
<p class="alert alert-primary">
    다음은 우리대학의 <b><u>발전계획에 대한 만족도 수준</u></b>을 묻는 문항입니다. 귀하의 생각과 가장 가까운 번호를 골라 1에서 5까지의
    숫자 중에서 선택해 주시기 바랍니다.
</p>
<!-- Question 1.1 -->
<br>
<p>
    1. 다음은 <b><u>특성화 및 발전계획</u></b>에 대한 만족도 수준을 묻는 문항입니다.
</p>
...
<div class="middle">
        ...
        <div class="card-body">
            <!-- Question 1.1 -->
            <p>
                1) 대학의 가치 체계와 중장기 발전계획에 대한 주요 내용을 명확히 인지하고 있다.
            </p>
            ...
            <!-- Question 1.2 -->
            <p>
                2) 대학 중장기 발전계획 수립 과정에서 구성원의 의견이 충분히 반영되었다.
            </p>
            <table class="table table-bordered table-responsive" >
                <thead class="thead-default">
                <tr>
            ...
            <!-- Question 1.3 -->
            <p>
                3) 대학이 추구하는 비전과 인재상을 명확히 인지하고 달성하고자 노력하고 있다.
            </p>
            <table class="table table-bordered table-responsive" >
                <thead class="thead-default">
                <tr>
            ...
            <!-- Question 1.4 -->
            <p>
                4) 대학의 중장기 발전계획을 추진함에 있어 다양한 지원을 충분히 하고 있다.
            </p>
            <table class="table table-bordered table-responsive" >
                <thead class="thead-default">
                <tr>
            ...
            <!-- Question 1.5 -->
            <p>
                5) 대학에서는 중장기 발전계획에 대한 성과관리를 적절하게 추진하고 있다.
            </p>
            <table class="table table-bordered table-responsive" >
                <thead class="thead-default">
                <tr>
