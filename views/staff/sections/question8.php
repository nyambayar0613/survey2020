...
<div class="middle">
    <!-- Question 8.1 -->
    <p>
        1. 다음은 대학의 <b><u>전반적 만족도에</u></b> 대한 만족도 수준을 묻는 문항입니다.
    </p>
        <div class="card-body">
            <!-- Question 8.1.1 -->
            <p>
                1) 연암대학교 직원으로써 대학 전반에 대해 만족하고 있다.
            </p>
            ...
            <!-- Question 8.1.2 -->
            <p>
                2)  경쟁 대학과 비교하여 교육 경쟁력과 지속가능성이 충분하다고 생각한다.
            </p>
            <table class="table table-bordered table-responsive" >
                <thead class="thead-default">
                <tr>
    ...
    <textarea class="form-control" v-model="questions.q8_1_1_1" id="exampleFormControlTextarea1" rows="5"></textarea>
</div>