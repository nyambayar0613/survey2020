...
<div class=container id="app">
    <div>
        <form-wizard @on-complete="onComplete" title="" subtitle="" color="grey">
            ...
            <tab-content title="교육" :before-change="validateQ2_1">
                <div class="question-section" >
                    <!-- Question 2.1 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅱ. 교육</h4>
                    </div>
                    <?php include('sections/question2_1.php'); ?>
                </div>
            </tab-content>
            ...
            <tab-content title="대학구성원" :before-change="validateQ3_1">
                <div class="question-section">
                    <!-- Question 3 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅲ. 교원평가 및 지원</h4>
                    </div>
                    <?php include('sections/question3_1.php'); ?>
                </div>
            </tab-content>

            <tab-content title="대학구성원" :before-change="validateQ3_2">
                <div class="question-section">
                    <!-- Question 3 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅲ. 교원평가 및 지원</h4>
            ...
            <tab-content title="대학구성원" :before-change="validateQ3_3">
                <div class="question-section">
                    <!-- Question 3 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅲ. 교원평가 및 지원</h4>
            ...
            <tab-content title="대학구성원" :before-change="validateQ3_4">
                <div class="question-section">
                    <!-- Question 3 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅲ. 교원평가 및 지원</h4>
            ...
            <tab-content title="교육시설" :before-change="validateQ4_1" >
                <div class="question-section">
                    <!-- Question 4.1 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅳ. 교육시설</h4>
                    </div>
                    <?php include('sections/question4_1.php'); ?>
                </div>
            </tab-content>
            ...
            <tab-content title="사회봉사" :before-change="validateQ6_1" >
                <div class="question-section">
                    <!-- Question 6.1.2 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅵ. 학생지원</h4>
                    </div>
                    <?php include('sections/question6_1.php'); ?>
                </div>
            </tab-content>

            <tab-content title="사회봉사" :before-change="validateQ6_3" >
                <div class="question-section">
                    <!-- Question 6.3.4.5 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅵ. 학생지원</h4>
                    </div>
                    <?php include('sections/question6_3.php'); ?>
                </div>
            </tab-content>

            <tab-content title="사회봉사" :before-change="validateQ6_5" >
                <div class="question-section">
                    <!-- Question 6.3.4.5 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅵ. 학생지원</h4>
            ...
            <tab-content title="사회봉사" :before-change="validateQ6_6" >
                <div class="question-section">
                    <!-- Question 6.6.7.8 -->
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅵ. 학생지원</h4>
            ...
            <tab-content title="대학의 전반적 만족도" :before-change="validateQ7" >
                <div class="question-section">
                    <!-- Question 7 -->
                    <div class="alert alert-secondary" role="alert">
            ...
            <tab-content title="코로나" :before-change="validateQC9">
                <div class="question-section">
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅸ. 코로나 19로 인한 비대면 원격 수업 및 교육환경 만족도</h4>
                    </div>
                    <?php include('sections/question9_corona.php'); ?>
                </div>
            </tab-content>

            <tab-content title="코로나" :before-change="validateQC9_2" >
                <div class="question-section">
                    <div class="alert alert-secondary" role="alert">
                        <h4 class="center header">Ⅸ. 코로나 19로 인한 비대면 원격 수업 및 교육환경 만족도</h4>
                    </div>
                    <?php include('sections/question9_2corona.php'); ?>
                </div>
            </tab-content>

            <tab-content title="주관식 문항" :before-change="validateQ9" >
                <div class="question-section">
