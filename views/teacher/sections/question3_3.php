...
<div class="middle">
    <br>
    <p>
        3. 다음은 <b><u>조직문화에</b></u> 대한 만족도 수준을 묻는 문항입니다.
    </p>
    <div class="card-body">
        <p>
    ...
    <br>
    <p>
        3.1 대학의 조직문화 활성화를 위해 필요한 것은 무엇인지 간략하게 기술하십시오.
    </p>

    <textarea v-model="questions.q3_3_1_1" style="height: 90px" cols="30" rows="2" class="form-control"></textarea>
</div>
